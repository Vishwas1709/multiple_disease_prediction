...
diabetes_model = pickle.load(open("D:/project/diabetes_model_new.sav",'rb'))
heart_model = pickle.load(open("D:/project/heart_disease_model.sav",'rb'))
parkinsons_model = pickle.load(open("D:/project/parkinsons_model.sav",'rb'))
breast_model = pickle.load(open("D:/project/breast_cancer_model.sav",'rb'))
...
if (selected == 'Diabetes Prediction'):
    ...
    with col3:
        # Convert input values to numeric type
        numeric_inputs = [float(val) for val in [Pregnancies, Glucose, BloodPressure, SkinThickness, Insulin, BMI, DiabetesPedigreeFunction, Age] if val != '']
...
if selected == 'Breast Cancer Prediction':
    ...
    numeric_inputs = [float(val) for val in [mean_radius, mean_texture, mean_perimeter, mean_area,
                                             ...
                                             worst_concave_points, worst_symmetry, worst_fractal_dimension]if val != '']
